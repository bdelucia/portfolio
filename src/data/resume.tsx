...
export const DATA = {
    ...
    summary:
        "I’ve grown from playing Reader Rabbit in 1st grade to building my first computer at 13, and now to developing full-stack applications from the ground up. I also have a small background in game development and data science from my studies during my time at ASU. I also make a mean chicken parmesan (check out my blog post about it). I also use Arch btw",
    avatarUrl: "/me.png",
    skills: [
        "React",
        "Next.js",
